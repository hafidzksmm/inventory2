                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center">
                                 <div>
                <h6 class="font-weight-semibold text-lg mb-0">📦 Data Inventaris</h6>
                <p class="text-sm text-secondary mb-0">Menampilkan semua data inventaris</p>
            </div>
           <!-- Tombol Tambah Data -->
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="text-white">Inventory Workshop</h4>
...
<div class="modal fade" id="addInventarisModal" tabindex="-1" aria-labelledby="addInventarisModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-scrollable"> {{-- scrollable agar bisa digulir --}}
    ...
    <!-- Form Hapus -->
    <form action="{{ route('ws.hapus', $item->id) }}" 
...
<div class="modal-content">
    <form action="{{ route('ws.update', $item->id) }}" method="POST">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                <label for="merk{{ $item->id }}" class="form-label">Merk</label>
